...
block_chain.new_transaction("kuri", "Eric", 150)
block_chain.new_block(proof2)
print(block_chain.chain)

block_chain.new_transaction("kuri", "Topher", 200)
block_chain.new_block(proof3)
print(block_chain.chain)
